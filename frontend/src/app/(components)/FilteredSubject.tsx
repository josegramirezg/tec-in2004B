...
import { FilteredSubjectProps } from "../../types/filteredSubject";
import React from "react";

export function FilteredSubject({ subject }: FilteredSubjectProps) {
  return (
    <>
      <GridItem colSpan={3}>
        <VStack
        ...
        {Array.from(
          ...
          return (
            <Box key={mod.id}>
              ...
              <Grid templateColumns={{base: "repeat(1, 1fr)", sm: "repeat(2, 1fr)", md: "repeat(3, 1fr)"}} gap="24px" my="20px">
                <SubjectCard
